...
- `core.tarifa` → `categoria_pasajero` (`general`|`inapam`|`menor`, en la llave) + `tope_asientos`
  ...
  revertido en Ses. 68, ver `0069_snapshot_boleto_categoria.sql`).
