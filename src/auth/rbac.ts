 ...
 */
export async function puede(node: Client, rol: string, permiso: string): Promise<boolean> {
...
export async function permisosDe(node: Client, rol: string): Promise<string[]> {
