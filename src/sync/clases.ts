...
export const CLASE_POR_TABLA: Readonly<Record<string, ClaseEntidad>> = {
  ...
  'core.rol_permiso': 'A',
  // Añadidas por 0034 y 0035 (F2b): la nube es la autoridad. El hash de
  // contraseña (03 §1.2) y la semilla HOTP de revocación (03 §1.5) se generan en
  // la nube y bajan replicados. `sesion` e `intento` sí son estado local del nodo.
  'auth_local.credencial': 'A',
  'auth_local.revocacion_hotp': 'A',
