...
// Ancla de reloj EN EL FUTURO: los fixtures siembran usuarios/config con
// `effective_from = now()` (hora real); fija, la ancla se queda atrás y todo
// parece "no vigente" (ver PR #81).
